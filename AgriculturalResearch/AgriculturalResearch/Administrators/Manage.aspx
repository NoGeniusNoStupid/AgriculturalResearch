<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="AgriculturalResearch.Administrators.Manage" %>
...
<div class="title"><h2>管理员管理</h2></div>
       <form runat="server">
<div class="query">
       ...
       <asp:GridView CssClass="table table-hover" ID="GvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                      ...
                      <Columns>
                          ...
                          <asp:TemplateField HeaderText="添加时间">
                                <ItemTemplate>
                                    <asp:Label ID="AddTime" runat="server" Text='<%# Bind("AddTime") %>' Width="120px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="120px" />
                            </asp:TemplateField>   
                            ...
                            <asp:TemplateField HeaderText="操作" ShowHeader="False">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"/Manage.aspx?type=1&id="+Eval("id") %>'
